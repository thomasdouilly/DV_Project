...
mean_label = alt.Chart(pd.DataFrame({'mean_value': [mean_value]})).mark_text(color='lightblue', dx=-317, dy=0, align='left').encode(
...
chart = chart.configure_view(width=725, height=200)
